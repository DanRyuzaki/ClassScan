...
import '../presentation/student_screen.dart';
...
class StudentAuthScreen extends StatefulWidget {
  ...
  const StudentAuthScreen({super.key, this.onBack, this.fromSignOut = false});
  @override
...
class _StudentAuthScreenState extends State<StudentAuthScreen>
  ...
  final StudentAuthController controller = StudentAuthController();
  ...
  void initState() {
    ...
    if (!widget.fromSignOut) _checkSession();
  }

  Future<void> _checkSession() async {
    if (_isNavigating) return;
    final isStudent = await controller.isSignedInAsStudent();
    if (isStudent && mounted && !_isNavigating) _goToDashboard();
  }
  ...
  void _goToDashboard() {
    ...
    Navigator.of(
      context,
    ).pushReplacement(MaterialPageRoute(builder: (_) => const StudentScreen()));
  }
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        ...
                        'Teacher accounts will be redirected.',
                        style: TextStyle(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Sign in with your Google account. Teacher accounts will be redirected.',
                        style: const TextStyle(
                          color: _textSecondary,
                          fontSize: 12,
                          height: 1.5,
  ...
  Widget _buildGoogleButton() {
    return GestureDetector(
      onTap: controller.isLoading ? null : _handleSignIn,
      child: MouseRegion(
        cursor: SystemMouseCursors.click,
